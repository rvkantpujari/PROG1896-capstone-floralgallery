            ...
            <div class="flex flex-col justify-between flex-1 mt-2 w-screen md:w-56 h-screen pl-12 py-8 md:p-8">
                <nav class="md:-mx-3 space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{route('admin.provinces')}}" class="{{Request::routeIs('admin.provinces') || Request::routeIs('admin.province.edit') ? 'bg-gray-100 text-gray-900' : 'text-gray-200'}} flex items-center px-4 py-2 mx-6 lg:mx-2 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-900">
                        ...
                        <a href="{{route('admin.customers')}}" class="{{Request::routeIs('admin.customers') || Request::routeIs('admin.customer.edit') ? 'bg-gray-100 text-gray-900' : 'text-gray-200'}} flex items-center px-4 py-2 mx-6 lg:mx-2 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="{{route('admin.sellers')}}" class="{{Request::routeIs('admin.sellers') || Request::routeIs('admin.seller.edit') ? 'bg-gray-100 text-gray-900' : 'text-gray-200'}} flex items-center px-4 py-2 mx-6 lg:mx-2 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="{{route('admin.categories')}}" class="{{Request::routeIs('admin.categories') || Request::routeIs('admin.category.edit') ? 'bg-gray-100 text-gray-900' : 'text-gray-200'}} flex items-center px-4 py-2 mx-6 lg:mx-2 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="{{route('admin.products')}}" class="{{Request::routeIs('admin.products') || Request::routeIs('admin.product.edit') ? 'bg-gray-100 text-gray-900' : 'text-gray-200'}} flex items-center px-4 py-2 mx-6 lg:mx-2 text-gray-200 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-900" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
