...
@section('title', 'Admin Reset Password - FloralGallery')
@section('form-title', 'Admin - Reset Password')
@section('form')
    <form method="POST" action="{{ route('admin.password.store') }}" class="my-8 mx-2">
        @csrf
