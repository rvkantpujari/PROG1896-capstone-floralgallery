...
@section('title', 'Admin Forgot Password - FloralGallery')
@section('form-title', 'Admin Forgot Password')
@section('form')
    ...
    <form method="POST" action="{{ route('admin.password.email') }}" class="my-8 mx-2">
        @csrf
        <!-- Email Address -->
