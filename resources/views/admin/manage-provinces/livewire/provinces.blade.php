<section class="container my-8">
    ...
    @elseif (session()->has('delete-province-info'))
        <script>
            swal("Deleted!!", "{{session('delete-province-info')}}", "error", {
                button:true,
                button:"OK",
            });
        </script>
        ...
        <div class="-mx-4 -my-2 overflow-x-auto md:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden border border-gray-200 md:rounded-lg p-8">
                    <table id="provinces" class="min-w-full p-2 divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div class="flex items-center justify-center gap-x-6">
                                            ...
                                            <form method="POST" action="{{route('admin.province.destroy', ['id' => $province->id])}}">
                                                @csrf
                                                @method('patch')
