                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($sellers as $seller)
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm md:text-[16px] text-gray-500 whitespace-nowrap hover:text-pink-500 hover:font-semibold">
                                        <a href="{{route('admin.view.seller.products', ['seller_id' => $seller->id])}}">
                                            <span title="View Seller's Products">{{$seller->first_name}} {{$seller->last_name}}</span>
                                        </a>
                                    </td>
