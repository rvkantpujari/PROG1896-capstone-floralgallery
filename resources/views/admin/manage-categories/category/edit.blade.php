...
@section('title', 'Edit Category - FlowerGallery')

@section('main-content')
    {{-- Add Main Section Here!!! --}}
    <div class="w-full">
        <h1 class="text-center lg:text-left text-[26px] font-semibold m-8"><a href="{{url()->previous()}}">Manage Categorys</a> > <span class="text-pink-500">Edit Category</span></h1>
