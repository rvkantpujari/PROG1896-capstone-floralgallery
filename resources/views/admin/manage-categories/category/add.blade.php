...
@section('title', 'Admin - Add Category | FloralGallery')

@section('main-content')
    {{-- Add Main Section Here!!! --}}
    <div class="w-full">
        <h1 class="text-center lg:text-left text-[26px] font-semibold m-8 pt-4"><a href="{{url()->previous()}}">Manage Categorys</a> > <span class="text-pink-500">Add Category</span></h1>
        <div class="lg:w-4/5 mx-8 my-16 lg:mx-auto lg:my-20 p-4 bg-white shadow-md rounded-lg lg:p-0">
            ...
            <div class="flex flex-col md:px-8 md:py-4 lg:py-0 lg:px-4 lg:pb-12 lg:flex-row lg:justify-center">
                <form method="post" action="{{ route('admin.category.store') }}">
                    @csrf
                    <div class="py-4 px-8 lg:w-[40vw] lg:min-h-[20vh]">
                        <h2 class="pt-8 text-base font-semibold leading-7 text-gray-900">
                            Add Category Information
                        </h2>

                        <p class="mt-1 text-sm leading-6 text-gray-600">
                            Add Product Category information for floral products.
                        </p>

                        <div class="mt-6 grid grid-cols-6 gap-x-2 gap-y-4 md:grid-cols-12">
