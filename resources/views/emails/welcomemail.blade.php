...
<body>
    ...
    <p style="font-size: 18px"> 
        ...
        We're thrilled that you've joined our vibrant community. Explore our exquisite collection of bouquets, arrangements, and gifts crafted with love. 
        Let the fragrance and beauty of nature inspire you as you embark on a delightful floral journey with us. <br>
        Happy shopping! 🌻
    </p>
    <p style="font-size: 20px;">
        Regards,<br>
        <span style="color:#EF62A7;">Floral</span><span style="color:#000">Gallery</span>
    </p>
</body>
</html>