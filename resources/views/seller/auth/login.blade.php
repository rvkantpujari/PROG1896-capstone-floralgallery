...
@section('title', 'Seller Sign In - FloralGallery')
@section('form-title', 'Seller - Sign In')
@section('form')
    <form method="POST" action="{{ route('seller.login') }}" class="my-8 mx-2">
        @csrf
        <!-- Email Address -->
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <a href="{{ route('seller.password.request') }}" class="text-sm text-black hover:text-gray-500">
                Forget Password?
            </a>
            @endif
...
@section('form-link-up')
    ...
    <a href="{{route('seller.register')}}" class="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:no-underline hover:text-pink-500">
        Sign Up
    </a>
@endsection
