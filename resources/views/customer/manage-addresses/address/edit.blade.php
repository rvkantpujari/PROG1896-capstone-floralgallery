...
@section('title', 'Edit Delivery Address - FlowerGallery')
            ...
            <div class="p-4 bg-white shadow-md rounded-lg lg:p-0">
                <div class="max-w-3xl mx-auto flex flex-col md:px-8 md:py-12 lg:px-8 lg:py-16 lg:flex-row lg:justify-center">
                    <form method="post" action="{{route('customer.address.update')}}">
                        ...
                        <div class="px-8 w-full lg:min-h-[45vh]">
                                ...
                                <div class="col-span-6 md:col-span-12">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="user_full_name" id="user_full_name" autocomplete="given-name"
                                            ...
                                            value="{{old('user_full_name', $address->user_full_name)}}" autofocus
                                        />
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <select name="province_id" id="province_id" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-300 outline-none focus:border-white sm:text-sm sm:leading-6">
                                            ...
                                            @foreach ($provinces as $province)
                                                <option type="text" name="province_{{$province->province_id}}" {{$province->province_id == $address->province_id ? 'selected' : ''}}
