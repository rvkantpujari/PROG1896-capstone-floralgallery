...
@section('title', 'Forgot Password - FloralGallery')
...
@section('form')
    ...
    <form method="POST" action="{{ route('password.email') }}" class="my-8 mx-2">
        @csrf
        <!-- Email Address -->
...
@section('form-link-up')
    ...
    <a href="{{url('login')}}" class="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:no-underline hover:text-pink-500">
        Sign In
    </a>
@endsection
